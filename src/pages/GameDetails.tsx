    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white font-sans pb-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 pt-8">
        ...
        <Button 
          ...
          variant="ghost" 
          className="mb-6 text-gray-400 hover:text-white hover:bg-white/10 gap-2"
        >
        ...
        <div className="bg-[#121214]/90 border border-[#3bbe5d]/30 rounded-xl p-8 shadow-2xl backdrop-blur-md">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 space-y-6">
              <div>
                <h1 className="text-4xl md:text-5xl font-black font-pixel text-white tracking-wide mb-2">
                  {game.name}
                </h1>
            ...
            <div className="flex flex-col items-center justify-center p-8 bg-black/20 rounded-2xl border border-white/5">
              <div className="mb-6 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                  <span className="text-4xl font-black text-white font-pixel"> 
              ...
              <Button 
                ...
                className="w-full max-w-xs h-12 bg-[#3bbe5d] hover:bg-[#2ea64d] text-black font-bold font-pixel text-lg shadow-[0_0_20px_rgba(59,190,93,0.3)] hover:shadow-[0_0_30px_rgba(59,190,93,0.5)] transition-all"
              >
                SALVAR REVIEW
              </Button>
            </div>
